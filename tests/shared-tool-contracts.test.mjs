...
assert.match(bridge, /"com\.codex\.mobile\.pocketlobster" -> PROD_PORT/)
assert.match(bridge, /"com\.codex\.mobile\.pocketlobster\.test" -> OPERATOR_PORT/)
assert.match(bridge, /"com\.codex\.mobile\.pocketlobster\.beta" -> BETA_PORT/)
