...
assert.match(gradle, /versionCode = 348/)
assert.match(gradle, /versionName = "1\.0\.107-codex-cli-0\.153\.4-gpt-6-astra-ready-openminis-1\.12-phone-observation-sync-v348"/)
...
assert.match(workflow, /phone-observation-sync-v348-beta/)
assert.match(workflow, /PACKAGE_ID="com\.codex\.mobile\.pocketlobster\.beta"/)
assert.match(baselineScript, /versionCode = 348/)
