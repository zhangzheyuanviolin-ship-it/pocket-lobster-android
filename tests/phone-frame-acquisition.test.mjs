...
assert.match(capture, /requestedAfterUs/)
assert.match(capture, /YUV conversion is intentionally demand-driven/)
...
const runtime = read(root + 'app/src/main/java/com/codex/mobile/PhoneUiAgentRuntime.kt')
const quality = read(root + 'app/src/main/java/com/codex/mobile/PhoneUiFrameQuality.kt')
...
assert.match(runtime, /captureUsableVirtualFrame/)
assert.match(runtime, /lastRejectedFrame/)
assert.match(quality, /nonBlackPermille/)
assert.match(quality, /permille >= 100 \|\| average >= 20/)
assert.match(runtime, /minimumVirtualFrameUs/)
assert.match(runtime, /currentScreenInfo/)
