...
const messages: Record<UiLocale, Record<string, string>> = {
  ...
  en: {
    ...
    app_language_en: 'English',
    sidebar_expand: 'Show conversation history',
    sidebar_collapse: 'Hide conversation history',
    ...
    conversation_reload: 'Reload this conversation',
