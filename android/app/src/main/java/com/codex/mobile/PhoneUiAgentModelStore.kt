...
enum class PhoneUiModelProtocol(val value: String) {
    ...
    GUI_PLUS_NATIVE("gui-plus-native"),
...
object PhoneUiAgentModelStore {
    ...
    fun presets(): List<PhoneUiModelConfig> = listOf(
        ...
        PhoneUiModelConfig(
            id = "aliyun-gui-plus-2026-02-26",
            displayName = "阿里云 GUI Plus 2026-02-26（推荐）",
            baseUrl = "https://dashscope.aliyuncs.com/compatible-mode/v1",
            apiKey = "",
            modelId = "gui-plus-2026-02-26",
            protocol = PhoneUiModelProtocol.GUI_PLUS_NATIVE,
            isDefault = false,
        ),
        PhoneUiModelConfig(
            id = "aliyun-gui-plus",
            displayName = "阿里云 GUI Plus",
            baseUrl = "https://dashscope.aliyuncs.com/compatible-mode/v1",
            apiKey = "",
            modelId = "gui-plus",
            protocol = PhoneUiModelProtocol.GUI_PLUS_NATIVE,
        ...
        PhoneUiModelConfig(
            id = "aliyun-qwen38-max",
            displayName = "阿里云 Qwen3.8 Max",
            baseUrl = "https://dashscope.aliyuncs.com/compatible-mode/v1",
            apiKey = "",
            modelId = "qwen3.8-max",
        ...
        PhoneUiModelConfig(
            id = "aliyun-qwen38-flash",
            displayName = "阿里云 Qwen3.8 Flash",
            baseUrl = "https://dashscope.aliyuncs.com/compatible-mode/v1",
            apiKey = "",
        ...
        PhoneUiModelConfig(
            id = "aliyun-qwen35-flash",
            displayName = "阿里云 Qwen3.5 Flash",
            baseUrl = "https://dashscope.aliyuncs.com/compatible-mode/v1",
            apiKey = "",
